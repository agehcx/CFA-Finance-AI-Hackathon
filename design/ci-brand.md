...
The interface must feel: **professional · clean · data-dense · approachable**

While avoiding excessive decoration, the UI embraces a modern SaaS aesthetic:
- Light gray page backgrounds with crisp white content cards
- Subtle drop shadows (`shadow-sm`) and rounded corners (`rounded-xl` or `rounded-2xl`)
- Distinct visual hierarchy using typography weights rather than colors
- Semantic color coding (soft red, blue, green, orange) in badges and icons
...
:root {
  ...
  --brand-primary-muted:   rgba(37, 99, 235, 0.12);
